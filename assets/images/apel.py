...
def gambar(ctx, width, height):
    ...
    # Langsung mulai menggambar
    ctx.save() # Simpan state awal
    # Pusatkan gambar jika perlu, atau sesuaikan translasi
    # Karena di game_scene kita sudah translate, kita bisa sesuaikan di sini
    # Tapi biar aman, kita anggap titik 0,0 adalah pusat buah
